...
<div class="container-fluid px-4">
    ...
    <tr>
        ...
        {{-- Kolom tipe pesanan (pastikan nama field benar: tipe_pesanan) --}}
        <td>
            <span class="badge 
        ...
        {{-- Kolom total harga --}}
        <td class="fw-semibold">Rp {{ number_format($item->total_harga, 0, ',', '.') }}</td>
    ...
    <!-- MODAL SEMUA PESANAN (dipisahkan dari tabel biar rapi) -->
